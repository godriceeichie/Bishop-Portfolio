  ...
  return (
    <footer className={`${pathname == '/events' ? 'bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600' : 'bg-gradient-to-tr from-[#001D78] via-[#003194] to-[#2B77EA]'}  md:grid md:grid-cols-5`}>
      <div className="hidden md:block relative h-32 md:col-span-2 md:h-full">
        <Image
          src={bishopImg}
          alt="A picture of Bishop Yomi Isijola"
          className="absolute h-full w-full object-cover"
        />
      </div>

      <div className="px-4 py-16 sm:px-6 md:col-span-3 lg:px-8">
        ...
        <div className="mt-12 border-t border-gray-500 pt-12">
          <div className="flex flex-col md:gap-3 lg:gap-0 lg:flex-row lg:items-center sm:justify-between">
