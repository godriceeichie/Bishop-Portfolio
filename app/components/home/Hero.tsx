    ...
    >
      <div className='flex items-center px-4 lg:px-8 absolute bottom-0 left-0 right-0 top-0 h-full w-full bg-gradient-to-b from-[#49066D00] from-17% to-[#2B77EA] to-100%'>
        <div className='flex flex-col items-center lg:items-start gap-4'>
          ...
          <Link href={'https://www.youtube.com/@logosministries321'} className='bg-red flex items-center gap-2 bg-accent-color text-base text-white px-4 py-2 rounded'>Watch live on <AiOutlineYoutube size={25}/></Link>
        </div>
      </div>
    </div>
  )
